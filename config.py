...
output_slider_breaks = ["resource/fonts/Torus-Regular.ttf", 41-3, 1582, 904, (255, 142, 211), 'cc']
output_stars = ["resource/fonts/Torus-SemiBold.ttf", 39, 960, 134-3, (255, 255, 255), 'cc']
output_pp_current = ["resource/fonts/Torus-SemiBold.ttf", 66, 960-3, 920, (222, 0, 255), 'cc']
...
output_time_min = ["resource/fonts/Torus-Regular.ttf", 32, 650, 606-3, (255, 255, 255), 'cc']
